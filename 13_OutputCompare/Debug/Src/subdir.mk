...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F4 -DSTM32F411CEUx -DSTM32F411xE -c -I../Inc -I"D:/STM32/bajery/kursy/projekty/chip_headers/CMSIS/Include" -I"D:/STM32/bajery/kursy/projekty/chip_headers/CMSIS/Device/ST/STM32F4xx/Include" -O3 -ffunction-sections -fdata-sections -Wall -Wextra -pedantic -Wconversion -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
